...
if __name__ == "__main__":
    ...
    arquivos_para_testar = [
        ...
        'Imagens/Resultado AES_ECB/resultado_python_VistaAereaSP.bin',
        'Imagens/CisnePretoBranco.bin',
        'Imagens/Resultado AES_ECB/resultado_fpga_CisnePretoBranco.bin',
        'Imagens/Resultado AES_ECB/resultado_python_CisnePretoBranco.bin',
        'Imagens/FrutaPadraoConstanteCor.bin',
        'Imagens/Resultado AES_ECB/resultado_fpga_FrutaPadraoConstanteCor.bin',
        'Imagens/Resultado AES_ECB/resultado_python_FrutaPadraoConstanteCor.bin',
        'Imagens/ImagemTrabalhoModeloProprio.bin',
        'Imagens/Resultado AES_ECB/resultado_fpga_ImagemTrabalhoModeloProprio.bin',
        'Imagens/Resultado AES_ECB/resultado_python_ImagemTrabalhoModeloProprio.bin',
        'Imagens/ImagemTrabalhoModeloProprioPB.bin',
        'Imagens/Resultado AES_ECB/resultado_fpga_ImagemTrabalhoModeloProprioPB.bin',
        'Imagens/Resultado AES_ECB/resultado_python_ImagemTrabalhoModeloProprioPB.bin'
    ]
