...
CSV_OUTPUT_PATH = r'C:/Xilinx/Projetos/Dados Consolidados/dados_entropia.csv'
MODO_ENCRIPTACAO = 'AES_KeyAgility'  # Atualize para AES_ECB ou AES_Counter quando necessário
