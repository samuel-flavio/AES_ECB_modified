...
HD_PWD='C:/Xilinx/Projetos/TF/keyInjector/keyInjector.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log key_injector_cmod.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source key_injector_cmod.tcl -notrace
