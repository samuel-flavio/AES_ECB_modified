...
HD_PWD='C:/Xilinx/Projetos/TF/keyInjector/keyInjector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log key_injector_cmod.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source key_injector_cmod.tcl
